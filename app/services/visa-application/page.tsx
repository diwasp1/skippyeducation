...
export default function VisaApplicationPage() {
  ...
  <div className="absolute inset-0 flex items-end">
    <div className="container pb-20 md:pb-28">
      ...
      <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">Visa Application</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Australian Student Visa Assistance</h2>
              <p className="text-gray-600 mb-4">
                Navigating the Australian student visa application process can be complex and overwhelming. Our visa
                application service provides expert guidance to ensure your application is prepared correctly and
                submitted on time.
              </p>
              <p className="text-gray-600 mb-4">
                Our team of experienced visa specialists understands the requirements and procedures for Australian
                student visas. We provide comprehensive support throughout the entire process, from eligibility
                assessment to visa grant.
              </p>
              <div className="space-y-3 mt-6">
                ...
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-primary mr-2 mt-0.5" />
                  <span className="text-gray-600">Visa application submission</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-primary mr-2 mt-0.5" />
                  <span className="text-gray-600">Biometrics and health check guidance</span>
                </div>
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-primary mr-2 mt-0.5" />
                  <span className="text-gray-600">Application status monitoring</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Visa Application Process</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6">Benefits of Our Visa Service</h2>
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Benefit from our in-depth knowledge of Australian visa requirements and procedures.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Save time with our efficient and organized approach to visa applications.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Minimize stress and anxiety with our support throughout the visa application process.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Higher Success Rates</h3>
                    <p className="text-gray-600">
                      Improve your chances of visa approval with professionally prepared applications.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Genuine Temporary Entrant (GTE)</h3>
                  <p className="text-gray-600">
                    You must demonstrate that you genuinely intend to stay in Australia temporarily for study purposes.
                    This is assessed through a statement and supporting documents.
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Confirmation of Enrolment (CoE)</h3>
                  <p className="text-gray-600">
                    You must have a CoE from an Australian educational institution registered to accept international
                    students.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Financial Requirements</h3>
                  <p className="text-gray-600">
                    You must demonstrate that you have sufficient funds to cover your tuition fees, living expenses, and
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    You must meet the English language requirements, typically through tests like IELTS, TOEFL, or PTE,
                    unless exempted.
                  </p>
                </div>
              </div>
