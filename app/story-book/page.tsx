          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Australia is home to some of the world's top universities and
                offers a high-quality education system recognized globally. With
                its diverse culture, stunning landscapes, and excellent quality
                of life, Australia is an ideal destination for international
                students.
              </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Australia offers a diverse range of study options for
              international students across different education levels.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-primary hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-4">
                Australia has 43 universities offering undergraduate and
                postgraduate degrees across various disciplines. Australian
                universities are known for their research and innovation.
              </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-primary hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-4">
                Vocational Education and Training (VET) focuses on practical
                skills and work-specific training, offering certificates,
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-primary hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-4">
                Australia offers a wide range of English language courses for
                international students to improve their language skills before
        ...
        <div className="container">
          ...
          <div className="text-center mt-10">
            <Button asChild className="max-sm:w-50" variant="outline" size="lg">
              <Link href="/story-book">Explore All Study Destinations</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Australia offers a high quality of life with its diverse culture,
              beautiful landscapes, and excellent healthcare and transportation
              systems.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4 bg-white p-6 rounded-xl shadow-lg border-l-4 border-primary hover:shadow-xl transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    International students can choose from various accommodation
                    options, including on-campus housing, homestays, shared
                    rentals, and private rentals.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 bg-white p-6 rounded-xl shadow-lg border-l-4 border-secondary hover:shadow-xl transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Australia has a diverse climate, from tropical in the north
                    to temperate in the south. Most cities enjoy warm summers
                    and mild winters.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 bg-white p-6 rounded-xl shadow-lg border-l-4 border-primary hover:shadow-xl transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Australia is known for its relaxed lifestyle, multicultural
                    society, and love for outdoor activities.
                  </p>
                </div>
              </div>
            </div>
